...
const TermsService = () => {
  return (
    <section className={styles.tos}>
      <h2 className='subtitleTerms'>Termos de Serviço</h2>
      <p>Last Modified: September 15, 2023
        Greetings players,
        ...
        Dispute Resolution. If you reside in the United States, please read the binding arbitration clause and class action waiver in Part A of Section 16. It affects how disputes between us are resolved.
